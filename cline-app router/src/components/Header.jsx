								...
								<div className="main-menu">
									<nav className="navigation">
										<ul className="nav menu">
											...
											<Link to={""}><li className="active"><a href="#">Home<i className="icofont-rounded-down"></i></a>
												<ul className="dropdown">
													<li><a href="index.html">Home Page 1</a></li>
												</ul>
											</li></Link>
											{/* <li><a href="#">Doctos </a></li> */}
											<Link to={"docters"}><li><a href="#">Doctos</a></li></Link>
											{/* <li><a href="#">Services </a></li> */}
											<Link to={"service"}><li><a href="#">Services </a></li></Link>
											...
											<Link to={"blogs"}><li><a href="#">Blogs <i className="icofont-rounded-down"></i></a>
												<ul className="dropdown">
													<li><a href="blog-single.html">Blog Details</a></li>
												</ul>
											</li></Link>
											{/* <li><a href="contact.html">Contact Us</a></li> */}
											<Link to={"appointment"}><li><a href="contact.html">Contact Us</a></li></Link>
										</ul>
									</nav>
								</div>
							</div>
